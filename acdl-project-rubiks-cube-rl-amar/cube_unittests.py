...
from utils import num_of_solved_faces, num_of_solved_facelets
...
class TestGoalState(unittest.TestCase):
    ...
    # check that goal state returns true when we call is_goal_state_reached
    def testIsSolvedState(self):
        c = {"front": [[1,1,1],[1,1,1],[1,1,1]], "back": [[2,2,2],[2,2,2],[2,2,2]], "up": [[3,3,3],[3,3,3],[3,3,3]], "down": [[4,4,4],[4,4,4],[4,4,4]], "left": [[5,5,5],[5,5,5],[5,5,5]], "right": [[6,6,6],[6,6,6],[6,6,6]]}
        cube = Cube(c=c)
        self.assertTrue(cube.is_goal_state_reached())

    # check that non goal state returns false when we call is_goal_state_reached
    def testIsNotSolvedState(self):
        c = {"front": [[1,1,1],[1,2,1],[1,2,1]], "back": [[2,2,3],[2,3,2],[2,2,3]], "up": [[3,3,3],[3,3,3],[3,3,3]], "down": [[4,4,4],[4,4,4],[4,4,4]], "left": [[5,5,5],[5,5,5],[5,5,5]], "right": [[6,6,6],[6,6,6],[6,6,6]]}
        cube = Cube(c=c)
        self.assertFalse(cube.is_goal_state_reached())
...
class TestEquality(unittest.TestCase):
    ...
    def testAreNotEqual(self):
        c1 = {"front": [[1,1,1],[1,1,1],[1,1,1]], "back": [[2,2,2],[2,2,2],[2,2,2]], "up": [[3,3,3],[3,3,3],[3,3,3]], "down": [[4,4,4],[4,4,4],[4,4,4]], "left": [[5,5,5],[5,5,5],[5,5,5]], "right": [[6,6,6],[6,6,6],[6,6,6]]}
        c2 = {"front": [[1,1,1],[1,2,1],[1,2,1]], "back": [[2,2,3],[2,3,2],[2,2,3]], "up": [[3,3,3],[3,3,3],[3,3,3]], "down": [[4,4,4],[4,4,4],[4,4,4]], "left": [[5,5,5],[5,5,5],[5,5,5]], "right": [[6,6,6],[6,6,6],[6,6,6]]}
        cube1 = Cube(c=c1)
        cube2 = Cube(c=c2)
        self.assertFalse(cube1.equals(cube2))

class TestRewardHelpers(unittest.TestCase):
    def testCountSolvedSides(self):
        c1 = {"front": [[1,1,1],[1,1,1],[1,1,1]], "back": [[2,2,2],[2,2,2],[2,2,2]], "up": [[3,3,3],[3,3,3],[3,3,3]], "down": [[4,4,4],[4,4,4],[4,4,4]], "left": [[5,5,5],[5,5,5],[5,5,5]], "right": [[6,6,6],[6,6,6],[6,6,6]]}
        cube = Cube(c=c1)
        self.assertTrue(num_of_solved_faces(cube) == 6)

    def testNumPiecesCorrectSide(self):
        c1 = {"front": [[1,1,1],[1,1,1],[1,1,1]], "back": [[2,2,2],[2,2,2],[2,2,2]], "up": [[3,3,3],[3,3,3],[3,3,3]], "down": [[4,4,4],[4,4,4],[4,4,4]], "left": [[5,5,5],[5,5,5],[5,5,5]], "right": [[6,6,6],[6,6,6],[6,6,6]]}
        cube = Cube(c=c1)
        self.assertTrue(num_of_solved_facelets(cube) == 48)
